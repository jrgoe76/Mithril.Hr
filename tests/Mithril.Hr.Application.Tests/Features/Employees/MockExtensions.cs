...
{
    public static void Setup(this Mock<IIdGenerator> mock, Guid newId)
    {
        mock
    ...
    public static void Setup(this Mock<IGetEmployeeByIdQuery> mock, Employee employee)
    {
        mock.Setup(query => query.Get(employee.EmployeeId))
            .ReturnsAsync(employee);
    }

    public static void Setup(this Mock<IGetPositionByCodeQuery> mock, Position position)
    {
